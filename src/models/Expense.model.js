...
const expenseSchema = new mongoose.Schema(
  {
    ...
    phase:         { type: String, required: true, enum: ['pre_sowing', 'sowing', 'management', 'harvest', 'sale'] },
...
expenseSchema.pre('save', function (next) { this.updatedAt = Date.now(); next(); });
expenseSchema.pre('findOneAndUpdate', function (next) { this.set({ updatedAt: Date.now() }); next(); });
